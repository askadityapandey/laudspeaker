...
export class CreatePlansForExistingOrgs1717180399574 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.query(`ALTER TABLE public.organization ALTER COLUMN "planId" SET NOT NULL'`);
      await queryRunner.query(`ALTER TABLE ONLY public.organization ADD CONSTRAINT "UQ_9838b0567dc51c15e3679b2a6e3" UNIQUE ("planId")`);
      await queryRunner.query(`ALTER TABLE "organization" ADD CONSTRAINT "FK_9838b0567dc51c15e3679b2a6e3" FOREIGN KEY ("planId") REFERENCES "organization_plan"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
